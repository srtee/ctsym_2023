...
DOI: 10.5281/zenodo.7684733.](img/reproducible-definition-grid.svg){width=700px height=525px}
...
:::: {.columns}
::: {.column width="30%"}
![Richard Feynman (1918-1988), famous bongo player](img/feynman-13184-portrait-mini-2x.webp){width=100%}
:::
...
::: {.columns}
:::: {.column width="40%"}
![You can't do it all at once -- grab what's useful!](img/ResearchTools.jpg){.smallertext}
::::
...
![Change things quickly knowing you can always retrieve past versions!](img/VersionControl.jpg)
